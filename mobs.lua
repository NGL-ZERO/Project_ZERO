return {
    Slime = {ModelName = "slime", ParentName = "slimeZone", DefaultColor = Color3.fromRGB(0, 255, 0)},
    SpikeSlime = {ModelName = "slimeSpike", ParentName = "slimeSpikeZone", DefaultColor = Color3.fromRGB(255, 127, 0)},
    OreMonster = {ModelName = "oreMonster", ParentName = nil, HasSubModel = true, DefaultColor = Color3.fromRGB(0, 127, 255)},
    SlimeCat = {ModelName = "slimeCat", ParentName = "slimeCatZone", DefaultColor = Color3.fromRGB(179, 42, 172)},
    Turret = {ModelName = "Turret", ParentName = "turret", DefaultColor = Color3.fromRGB(100, 100, 100)},
    SlimeVoid = {ModelName = "slimeVoid", ParentName = "slimeVoidZone", DefaultColor = Color3.fromRGB(0, 1, 87)},
